...
`const social = [
    ...
    },
    {
      name: "Email",
      icon: "email",
      link: "mailto:diegomaldinifreyre@gmail.com",
    },
];`,
    language: "tsx",
    label: "src/app/resources/content.js"
...
`const home = {
    label: "Home",
    title: "Diego M. Maldini Freyre's Portfolio",
    description: "Portfolio website showcasing my work as an AI Transformation & Automation Partner",
    headline: <>AI Engineer and Full-Stack Developer</>,
    subline: (
      <>
        I'm Diego, an AI Engineer specializing in <InlineCode>AI Agents, LLMs, and Automation</InlineCode>,
        <br /> transforming businesses through intelligent solutions.
      </>
    ),
};`,
    language: "tsx",
